...
-- UPDATE Product SET Description = new_description WHERE ProductID = product_id;
...
-- DELETE FROM ProductReview WHERE Review_ID = 7;
...
-- Explaination
-- In this example, we have two SQL UPDATE statements that are attempting to modify the quantity of the product_id=1. 
